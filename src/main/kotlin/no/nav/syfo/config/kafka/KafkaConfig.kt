...
class KafkaConfig(
    ...
    fun commonKafkaAivenConsumerConfig(): Map<String, Any> = mapOf(
    ...
    fun commonKafkaAivenProducerConfig(): Map<String, Any> = mapOf(
    ...
    private fun securityConfig(): Map<String, Any> = if (env.isLocal()) {
        mapOf()
    } else {
        mapOf<String, Any>(
